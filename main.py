...
def create_menu():
    ...
    menu.add_option('3', 'Delete Book', delete_book)
    menu.add_option('4', 'Show Unread Books', show_unread_books)
    menu.add_option('5', 'Show Read Books', show_read_books)
    menu.add_option('6', 'Show All Books', show_all_books)
